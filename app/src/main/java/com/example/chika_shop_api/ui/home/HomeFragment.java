package com.example.chika_shop_api.ui.home;
...
import com.example.chika_shop_api.databinding.FragmentHomeBinding;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding.basketBtn.setAnimation(R.raw.cart);
        binding.basketBtn.setRepeatCount(LottieDrawable.INFINITE);
        binding.basketBtn.playAnimation();
        setUpOnBackPressed();
        return root;
    }
